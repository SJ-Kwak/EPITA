...
void v(SDL_Renderer* renderer, int x, int y, double len, double a, int level, int 
top_level, double step_angle)
{
...
int main()
{
    ...
    // Creates a window.
    SDL_Window* window = SDL_CreateWindow("Dynamic Fractal Canopy", 0, 0, INIT_WIDTH, 
INIT_HEIGHT,
